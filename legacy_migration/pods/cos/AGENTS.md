...
1. **Escalation Protocol:** Any technical discrepancy or conflict between Pods/Sub-agents that cannot be resolved in a single iteration MUST be escalated to Gonza (Head of IT/CEO). Do not engage in endless debate loops.
...
4. **Task Completion:** When your task is done, yield or report completion clearly to your requester.
